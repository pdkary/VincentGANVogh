class GanShapeConfig():
  def __init__(self,img_shape,latent_size,style_size,kernel_size,style_layer_size,style_layers,gen_layer_shapes,disc_layer_shapes,disc_dense_sizes,minibatch_size):
...
class GanTrainingConfig():
  def __init__(self,learning_rate,disc_loss_function,gen_loss_function,noise_mode,gauss_factor,batch_size,preview_rows,
