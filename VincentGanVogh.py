...
def gen_layer(f,c,k,act=conv_lr,u=True,t=True,n=0.1,id="",norm=NoneCallable):
  return GenLayerConfig(f,c,k,act,upsampling=u,transpose=t,noise=n,track_id=id,normalization=norm)

def disc_layer(f,c,k,act=conv_lr,d=True,t=False,dr=0.25,n=0.0,id="",norm=NoneCallable):
...
#       gen_layer(128,3,3,norm=instance_norm,n=0.0),
#       gen_layer(64, 2,3,norm=instance_norm,n=0.0),
#       gen_layer(channels,1,1,sigmoid,n=0.0)
#     ],
# )   
...
gan_training_config = GanTrainingConfig(
    ...
    gen_optimizer = Adam(learning_rate=8e-6),#beta_1=0.0,beta_2=0.99,epsilon=1e-7),
    disc_optimizer = Adam(learning_rate=8e-6),#beta_1=0.0,beta_2=0.99,epsilon=1e-7),
    metrics = [Mean],
    preview_rows=3,
    preview_cols=4,
    preview_margin=6
