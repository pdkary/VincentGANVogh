...
class ViewableStyleTrainer(AbstractTrainer):
    ...
    def save_images(self,name):
        ...
        self.D.gan_input.save(name+"_out",gen_images,self.preview_rows,self.preview_cols,self.preview_margin)
        self.D.gan_input.save_viewed(name+"_progression",gen_views,self.preview_margin)
    ...
    def train_generator(self,source_input, gen_input):
        with tf.GradientTape() as gen_tape:
            ...
            view_losses = [tf.zeros_like(x) for x in disc_view] 
